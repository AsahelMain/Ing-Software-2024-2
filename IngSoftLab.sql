...
create user 'asmc'@'localhost' identified by 'Developer123!';

grant all privileges on lab_ing_software.* to 'asmc'@'localhost'
with grant option;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utfmb4_0900_ai_ci;
